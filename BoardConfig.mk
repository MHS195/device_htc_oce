...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 3000000000 # For smallest China variant, 3690987520 for Euro DUGL / UHL
BOARD_VENDORIMAGE_PARTITION_SIZE := 690987520
BOARD_VENDORIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_USERDATAIMAGE_PARTITION_SIZE := 59039023104
TARGET_USES_MKE2FS := true

# halium
HYBRIS_MEDIA_32BIT_ONLY := false
